...
class ParametersTest < ApplicationSystemTestCase
  ...
  test "creating a Parameter" do
    ...
    fill_in "Access Token", with: @parameter.access_token
    fill_in "Access Token Secret", with: @parameter.access_token_secret
    fill_in "Consumer Key", with: @parameter.consumer_key
    fill_in "Consumer Secret", with: @parameter.consumer_secret
    fill_in "Lang", with: @parameter.lang
